...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{itemize}
	\item Implement Network generation as in \cite{Gomez-Gardenes_2006} $\leftarrow$ DONE
	\item Implement MOR, REP and UI update rules
	\item Implement UG dynamics (?) 
	\item test everything!!
	\item Implement additional update rules? Implement PDG just to check and verify?
	\
\end{itemize}
